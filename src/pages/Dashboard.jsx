    ...
    return (
        <div>
            ...
            <Row gutter={[24, 24]} className="pt-10">
                <DashboardCard title="TOTAL USERS" value="1110"/>
                <DashboardCard title="TOTAL FOOD ITEMS" value="20"/>
                <DashboardCard title="TOTAL ORDERS" value="10"/>
            </Row>
            <Row className="p-6 pt-24">
                <Col xs={{span: 24}} md={{span: 12}} lg={{span: 8}}>
                    <p className="text-base font-normal pb-6"><span className="bg-backgroundYellow p-2 rounded-xl">TODAY RECORDS</span></p>
                    <p className="text-3xl font-medium pb-10">Available Orders: <span className="text-red-700">10</span>
                    </p>
                    <p className="text-3xl font-medium pb-10">Processing Orders: <span
                        className="text-yellow-700">5</span></p>
                    <p className="text-3xl font-medium">Completed Orders: <span className="text-green-700">2</span></p>
                </Col>
